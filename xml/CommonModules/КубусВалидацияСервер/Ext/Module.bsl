...
Функция ВалидацияПараметровHTTPЗапроса(Знач HTTPСервисЗапрос, ШаблонВалидацииJSON) Экспорт
	...
	КубусОбщегоНазначенияКлиентСервер.ПроверитьПараметрФункции(
		"ВалидацияПараметровHTTPЗапроса",
		"HTTPСервисЗапрос",
...
Функция ВалидацияЗаголовковHTTPЗапроса(Знач HTTPСервисЗапрос, ШаблонВалидацииJSON) Экспорт
	ВызватьИсключение "Функционал не реализован";
КонецФункции

Функция ВалидацияТелаHTTPЗапроса(Знач HTTPСервисЗапрос, ШаблонВалидацииJSON) Экспорт
	ВызватьИсключение "Функционал не реализован";
КонецФункции
	...
	Если Правило = Истина Тогда
		...
		Если Значение = Неопределено Тогда
			...
			СтруктураВозврата.ОшибкиВалидации.Добавить(
				КубусОбщегоНазначенияКлиентСервер.ПодставитьПараметрыВСтроку(
					КубусСтроковыеЗначенияКлиентСервер.Все().Ошибки.ВалидацииОпущенПараметр,
					ИмяПараметра));
		...
		ИначеЕсли НЕ ЗначениеЗаполнено(Значение) Тогда
			...
			СтруктураВозврата.ОшибкиВалидации.Добавить(
				КубусОбщегоНазначенияКлиентСервер.ПодставитьПараметрыВСтроку(
					КубусСтроковыеЗначенияКлиентСервер.Все().Ошибки.ВалидацииПараметрНеЗаполнен,
					ИмяПараметра));
...
Функция _number(ИмяПараметра, Значение)
	...
	Исключение
		...
		СтруктураВозврата.ОшибкиВалидации.Добавить(
			КубусОбщегоНазначенияКлиентСервер.ПодставитьПараметрыВСтроку(
				КубусСтроковыеЗначенияКлиентСервер.Все().Ошибки.ВалидацииПараметрДолженБытьЧислом,
				ИмяПараметра));
